...
#
#python ase/run.py --test --algo_name common_test --task HumanoidImitationTrackTest --cfg_env ase/data/cfg/other_setup/humanoid_imitation_vrh.yaml --cfg_train ase/data/cfg/train/rlg/common_ppo_humanoid.yaml --motion_file ase/data/motions/dataset_lafansimilar_test.yaml --checkpoint output_final_exps_1_72/HumanoidImitation_09-07-08-30-33/nn/HumanoidImitation.pth --num_envs 10 --headless
#
#python ase/run.py --test --algo_name common_test --task HumanoidImitationTrackTest --cfg_env ase/data/cfg/other_setup/humanoid_imitation_vrh_rewPenaltyAndReach.yaml --cfg_train ase/data/cfg/train/rlg/common_ppo_humanoid.yaml --motion_file ase/data/motions/dataset_lafansimilar_test.yaml --checkpoint output_final_exps_1_72/HumanoidImitation_09-07-08-30-33/nn/HumanoidImitation.pth --num_envs 10 --headless
#
#
#
#
...
#
#python ase/run.py --test --algo_name common_test --task HumanoidImitationTrackTest --cfg_env ase/data/cfg/other_setup/humanoid_imitation_vrh.yaml --cfg_train ase/data/cfg/train/rlg/common_ppo_humanoid_v3.yaml --motion_file ase/data/motions/dataset_lafansimilar_test.yaml --checkpoint output_final_exps_1_72/HumanoidImitation_07-07-18-24-42/nn/HumanoidImitation.pth --num_envs 10 --headless
#
#python ase/run.py --test --algo_name common_test --task HumanoidImitationTrackTest --cfg_env ase/data/cfg/other_setup/humanoid_imitation_vrh_rewPenaltyAndReach.yaml --cfg_train ase/data/cfg/train/rlg/common_ppo_humanoid_v3.yaml --motion_file ase/data/motions/dataset_lafansimilar_test.yaml --checkpoint output_final_exps_1_72/HumanoidImitation_07-07-18-24-42/nn/HumanoidImitation.pth --num_envs 10 --headless
