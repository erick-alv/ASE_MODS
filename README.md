...
# Network weigths
The network weights can be found at https://syncandshare.lrz.de/getlink/fi6vrL9FpeSM2hbzySDrnw/datasets_files . For a description, please read the [readme](https://github.com/erick-alv/RL-CharacterControl/blob/main/training_output/README.md).
